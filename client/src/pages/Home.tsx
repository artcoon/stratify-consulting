      ...
      <main className="flex-grow">
        ...
        <section id="portfolio" className="py-24">
          <div className="container">
            ...
            {/* GIS PROJECT TRACKER — 25 sites */}
            <div className="max-w-4xl mx-auto mb-20 flex flex-col gap-6 text-left">
              <div className="flex flex-col gap-2">
                <span className="text-[10px] font-bold text-primary uppercase tracking-wider">GIS Project Tracker</span>
                <h3 className="font-serif text-xl font-bold text-[#173B57]">(주)이에스조경 준공 현장 지도 (25개소)</h3>
                <p className="text-xs text-muted-foreground font-medium leading-relaxed">
                  경기 광주시 및 인근 지역 25개 준공 현장의 위치입니다. 녹색 ES 마커는 대표 실적 3건, 일반 마커는 추가 공사 히스토리입니다. 마커를 클릭하면 현장명·발주처·실적 규모를 확인할 수 있습니다.
                </p>
              </div>
              <div className="rounded-2xl overflow-hidden border border-border shadow-xl">
                <ProjectMap sites={PROJECT_SITES} className="h-[420px] w-full" />
              </div>
              <div className="rounded-xl border border-border/80 bg-card/40 p-4">
                <p className="text-[10px] font-bold text-primary uppercase tracking-wider mb-3">
                  공사 히스토리 현장 위치 ({PROJECT_SITES.length}개소)
                </p>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-64 overflow-y-auto pr-1">
                  {PROJECT_SITES.map((site) => (
                    ...
                    >
                      ...
                      <span>
                        <span className="text-foreground font-bold">{site.title}</span>
                        <span className="block text-[10px] text-primary/80 mt-0.5">
                          {formatProjectCoordinates(site.lat, site.lng)}
                          {site.year ? ` · ${site.year}` : ""}
                        </span>
                      </span>
                    </li>
